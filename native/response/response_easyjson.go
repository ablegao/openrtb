...
func easyjson6ff3ac1dDecodeGithubComAblegaoOpenrtbNativeResponse(in *jlexer.Lexer, out *Response) {
...
func easyjson6ff3ac1dEncodeGithubComAblegaoOpenrtbNativeResponse(out *jwriter.Writer, in Response) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Ver != "" {
...
func (v Response) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson6ff3ac1dEncodeGithubComAblegaoOpenrtbNativeResponse(&w, v)
...
func (v *Response) UnmarshalJSON(data []byte) error {
	...
	easyjson6ff3ac1dDecodeGithubComAblegaoOpenrtbNativeResponse(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Response) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson6ff3ac1dDecodeGithubComAblegaoOpenrtbNativeResponse(l, v)
}
