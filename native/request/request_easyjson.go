...
func easyjson3c9d2b01DecodeGithubComAblegaoOpenrtbNativeRequest(in *jlexer.Lexer, out *Request) {
...
func easyjson3c9d2b01EncodeGithubComAblegaoOpenrtbNativeRequest(out *jwriter.Writer, in Request) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Ver != "" {
...
func (v Request) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson3c9d2b01EncodeGithubComAblegaoOpenrtbNativeRequest(&w, v)
...
func (v *Request) UnmarshalJSON(data []byte) error {
	...
	easyjson3c9d2b01DecodeGithubComAblegaoOpenrtbNativeRequest(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Request) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson3c9d2b01DecodeGithubComAblegaoOpenrtbNativeRequest(l, v)
}
