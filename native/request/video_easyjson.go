...
func easyjson3c9ce8c3DecodeGithubComAblegaoOpenrtbNativeRequest(in *jlexer.Lexer, out *Video) {
...
func easyjson3c9ce8c3EncodeGithubComAblegaoOpenrtbNativeRequest(out *jwriter.Writer, in Video) {
	out.RawByte('{')
	first := true
	_ = first
	if len(in.Mimes) != 0 {
...
func (v Video) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson3c9ce8c3EncodeGithubComAblegaoOpenrtbNativeRequest(&w, v)
...
func (v *Video) UnmarshalJSON(data []byte) error {
	...
	easyjson3c9ce8c3DecodeGithubComAblegaoOpenrtbNativeRequest(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Video) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson3c9ce8c3DecodeGithubComAblegaoOpenrtbNativeRequest(l, v)
}
