...
func easyjson3eeb1cddDecodeGithubComAblegaoOpenrtb(in *jlexer.Lexer, out *Native) {
...
func easyjson3eeb1cddEncodeGithubComAblegaoOpenrtb(out *jwriter.Writer, in Native) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v Native) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson3eeb1cddEncodeGithubComAblegaoOpenrtb(&w, v)
...
func (v *Native) UnmarshalJSON(data []byte) error {
	...
	easyjson3eeb1cddDecodeGithubComAblegaoOpenrtb(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Native) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson3eeb1cddDecodeGithubComAblegaoOpenrtb(l, v)
}
