...
func easyjson3073ac56DecodeGithubComAblegaoOpenrtb(in *jlexer.Lexer, out *Device) {
	...
	for !in.IsDelim('}') {
		...
		case "geo":
			if in.IsNull() {
				...
				easyjson3073ac56DecodeGithubComAblegaoOpenrtb1(in, &*out.Geo)
			}
		case "dnt":
			out.DNT = int(in.Int())
		case "lmt":
...
func easyjson3073ac56EncodeGithubComAblegaoOpenrtb(out *jwriter.Writer, in Device) {
	out.RawByte('{')
	first := true
	_ = first
	if in.UA != "" {
	...
	if in.Geo != nil {
		...
		easyjson3073ac56EncodeGithubComAblegaoOpenrtb1(out, *in.Geo)
	}
	if in.DNT != 0 {
...
func (v Device) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson3073ac56EncodeGithubComAblegaoOpenrtb(&w, v)
...
func (v *Device) UnmarshalJSON(data []byte) error {
	...
	easyjson3073ac56DecodeGithubComAblegaoOpenrtb(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Device) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson3073ac56DecodeGithubComAblegaoOpenrtb(l, v)
}
func easyjson3073ac56DecodeGithubComAblegaoOpenrtb1(in *jlexer.Lexer, out *Geo) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson3073ac56EncodeGithubComAblegaoOpenrtb1(out *jwriter.Writer, in Geo) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Lat != 0 {
