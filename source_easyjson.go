...
func easyjson4f84393bDecodeGithubComAblegaoOpenrtb(in *jlexer.Lexer, out *Source) {
...
func easyjson4f84393bEncodeGithubComAblegaoOpenrtb(out *jwriter.Writer, in Source) {
	out.RawByte('{')
	first := true
	_ = first
...
func (v Source) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson4f84393bEncodeGithubComAblegaoOpenrtb(&w, v)
...
func (v *Source) UnmarshalJSON(data []byte) error {
	...
	easyjson4f84393bDecodeGithubComAblegaoOpenrtb(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Source) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson4f84393bDecodeGithubComAblegaoOpenrtb(l, v)
}
