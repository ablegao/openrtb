...
func easyjsonC16456caDecodeGithubComAblegaoOpenrtb(in *jlexer.Lexer, out *Banner) {
	...
	for !in.IsDelim('}') {
		...
		case "format":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v1 Format
					easyjsonC16456caDecodeGithubComAblegaoOpenrtb1(in, &v1)
...
func easyjsonC16456caEncodeGithubComAblegaoOpenrtb(out *jwriter.Writer, in Banner) {
	out.RawByte('{')
	first := true
	_ = first
	if in.W != 0 {
	...
	if len(in.Format) != 0 {
		...
		}
		{
			...
			for v7, v8 := range in.Format {
				...
				easyjsonC16456caEncodeGithubComAblegaoOpenrtb1(out, v8)
			}
			out.RawByte(']')
		}
	}
...
func (v Banner) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonC16456caEncodeGithubComAblegaoOpenrtb(&w, v)
...
func (v *Banner) UnmarshalJSON(data []byte) error {
	...
	easyjsonC16456caDecodeGithubComAblegaoOpenrtb(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Banner) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonC16456caDecodeGithubComAblegaoOpenrtb(l, v)
}
func easyjsonC16456caDecodeGithubComAblegaoOpenrtb1(in *jlexer.Lexer, out *Format) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonC16456caEncodeGithubComAblegaoOpenrtb1(out *jwriter.Writer, in Format) {
	out.RawByte('{')
	first := true
	_ = first
	if in.W != 0 {
